...
{
    public class GeneralSettingsData : IGeneralSettingsData
    {
        private ISettingsStorageManager storageManager;
        private ISettingsStorageContent content;

        public GeneralSettingsData(ISettingsStorageManager storageManager)
        {
        ...
        {
            content = new SettingsStorageContent(
