...
{
    public class StartPageViewModel : BaseViewModel, IPageViewModel, IFileDragDropTarget
    {
        ...
        public static readonly DependencyProperty IsFileDragDropEnabledProperty =
                DependencyProperty.RegisterAttached("IsFileDragDropEnabled", typeof(bool), typeof(StartPageViewModel), new PropertyMetadata(OnFileDragDropEnabled));

        public static readonly DependencyProperty FileDragDropTargetProperty =
                DependencyProperty.RegisterAttached("FileDragDropTarget", typeof(object), typeof(StartPageViewModel), null);
        ...
        public void OnFileDrop(string[] filepaths)
        {
            for (int i = 0; i < filepaths.Length; i++)
            {
                ...
                Mediator.Notify("LoadNewFile", filepaths[i]); 
               //FileHandler test = new FileHandler(filepaths[i]);
