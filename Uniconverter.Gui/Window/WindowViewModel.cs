...
namespace Uniconverter.Gui
{
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// </summary>
        public Thickness ResizerBorderThickness => new Thickness(OuterMarginSize.Left + ResizeBorder,
        ...
        /// Default constructor
        /// </summary>
        public WindowViewModel(Window window, INavigator navigator)
        {
            mWindow = window;
            ...
            // Create commands
            MinimizeCommand = new RelayCommandalt(() => mWindow.WindowState = WindowState.Minimized);
            MaximizeCommand = new RelayCommandalt(() => mWindow.WindowState ^= WindowState.Maximized);
            CloseCommand = new RelayCommandalt(() => mWindow.Close());
            MenuCommand = new RelayCommandalt(() => SystemCommands.ShowSystemMenu(mWindow, GetMousePosition()));
        ...
        private void WindowResized()
        {
            ...
            OnPropertyChanged(nameof(ResizerBorderThickness));
