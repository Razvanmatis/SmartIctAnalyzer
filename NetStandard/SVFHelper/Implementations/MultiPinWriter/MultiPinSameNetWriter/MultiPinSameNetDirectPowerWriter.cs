...
{
    public class MultiPinSameNetDirectPowerWriter : MultiPinSameNetWriterBase
    {
        public MultiPinSameNetDirectPowerWriter(List<PinTestTypeContainer> pinsToUse) : base(pinsToUse)
        {
        }
        ...
        public override string Description { get => "directly connected to Power with same nets"; }
