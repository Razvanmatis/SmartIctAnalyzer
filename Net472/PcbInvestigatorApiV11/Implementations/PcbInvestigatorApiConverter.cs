...
namespace PcbInvestigatorApiV11.Implementations
{
    ...
    public class PcbInvestigatorApiConverter : IPcbInvestigatorApiConverter
    {
        ...
        /// </summary>
        public static readonly Func<IFunctionalAttributes, bool> DefIsTestPoint
            = new Func<IFunctionalAttributes, bool>(
                (x) => x.PartName.Contains("testpoint") || x.PackageName.Contains("TP") || x.PartName.Contains("TP"));
        ...
        public IGrpcResult GetConvertedObjects(
            IList<StepComponentContainer> pcbObjects,
            IList<InterfaceNet> allNets,
            AbstractDataProvider dataProvider,
            int stepAmount)
        {
            return dataProvider.GetConvertedObjects(pcbObjects, allNets, ref isTestPoint, stepAmount);
        }

        public IList<NetGrpc> GetNetsGrpc(
            IList<IPinComponent> allPins,
            IList<IPCBComponent> allComponents,
        ...
        private static FunctionalAttributesGrpc GetFunctionalAttributesGrpc(IFunctionalAttributes functionalAttributes)
        {
            return new FunctionalAttributesGrpc()
            {
                ...
                StepNo = functionalAttributes.StepNo,
            };
        }
