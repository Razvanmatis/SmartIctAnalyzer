\chapter{Conclusion}
As a conclusion of the creation of the requested tool there could be definitely held that in dependency on all requirements, which were communicated by ProMik GmbH and the software developer a quite powerful and feature rich software was provided according to figure \ref{fig:projectOverview}. 
All at the beginning requested requirements from the enumerated list \ref{items:req} were successfully implemented. Further there were provided the following features as bonus content:
\begin{itemize}
