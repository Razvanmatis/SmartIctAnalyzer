\chapter{Appendix}
\section{User manual for working with the smart ICT analyzer tool}
...
\paragraph{GRPC server API connection settings}
...
\paragraph{Test Coverage settings}
...
\subsection{Creation of new project}
...
\subsection{Working with the components view}
...
\subsubsection{Determine all boundary scan objects}
...
\subsubsection{Performing any test coverage of objects}
...
\subsubsection{Export PIN connection information into file}
...
\subsubsection{Generate SVF data files}
...
\subsection{Drag and drop within the application}
