...
\includepdf[pages=-]{figures/erklärung.pdf}
\include{content/0_Abstract}
\tableofcontents

\mainmatter
\include{content/0_ListOfAbbreviations}
\include{content/1_Introduction}
\include{content/2_Fundamentals}
\include{content/3_ConceptualDesign}
\include{content/4_Architecture}
\include{content/5_Analysis}
\include{content/6_Conclusion}
\include{content/7_Thanksgiving}

% remove if not needed
\appendix
\include{content/8_Appendix}
